...
\usepackage{graphicx}
% Domyślne skalowanie obrazków, jeśli są za szerokie
\makeatletter
\def\maxwidth{\ifdim\Gin@nat@width>\linewidth\linewidth\else\Gin@nat@width\fi}
\def\maxheight{\ifdim\Gin@nat@height>\textheight\textheight\else\Gin@nat@height\fi}
\makeatother
% Ustawienie domyślnych parametrów dla \includegraphics
...
% Konfiguracja formatu rozdziału w nagłówku: sama nazwa rozdziału
\renewcommand{\chaptermark}[1]{\markboth{#1}{}}

\usepackage{setspace}
\setstretch{1.1} % Lekko powiększona interlinia dla czytelności

% Wylaczenie dzielenia wyrazow na koncu linii
\hyphenpenalty=10000
...
\usepackage[skip=5pt plus 2pt, indent=0pt]{parskip} % Mniejszy odstęp między akapitami

\usepackage{enumitem}
\setlist{nosep} % Ściśnięte listy
...
\makeatletter
\newif\ifmainchapterstarted
\mainchapterstartedfalse
\patchcmd{\chapter}{\if@openright\cleardoublepage\else\clearpage\fi}{}{}{}
\pretocmd{\chapter}{%
  \if@mainmatter
    \ifmainchapterstarted
      \clearpage
    \else
      \global\mainchapterstartedtrue
    \fi
  \else
    \clearpage
  \fi
...
\pretocmd{\@schapter}{\phantomsection}{}{}
\makeatother
...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\Large kpr. Grzegorz KASZUBA \par}
    \vfill
...
\makeatletter\typeout{MAINSTATE_BEFORE_BODY=\if@mainmatter T\else F\fi}\makeatother

\chapter{Czołg podstawowy T-72}\label{czoux142g-podstawowy-t-72}

\subsection{T-72 Main Battle Tank \textbar{} Т-72 Основной боевой
...
\section{Dane techniczne}\label{dane-techniczne}
...
\section{Charakterystyczne cechy
...
\section{Ciekawostka}\label{ciekawostka}
...
\chapter{Czołg podstawowy T-80}\label{czoux142g-podstawowy-t-80}

\subsection{T-80 Main Battle Tank \textbar{} Т-80 Основной боевой
...
\section{Dane techniczne}\label{dane-techniczne-1}
...
\section{Ciekawostka}\label{ciekawostka-1}
...
\chapter{Czołg podstawowy T-90}\label{czoux142g-podstawowy-t-90}

\subsection{T-90 Main Battle Tank \textbar{} Т-90 Основной боевой
...
\section{Dane techniczne}\label{dane-techniczne-2}
...
\section{Ciekawostka}\label{ciekawostka-2}
...
\chapter{Bojowy Wóz Piechoty BMP-1}\label{bojowy-wuxf3z-piechoty-bmp-1}

\subsection{BMP-1 Infantry Fighting Vehicle \textbar{} БМП-1 (Боевая
машина
...
\section{Dane techniczne}\label{dane-techniczne-3}
...
\item
  ...
  od BMP-3.
\item
  \textbf{Portki strzeleckie wzdłuż burt:} Wzdłuż bocznych powierzchni
...
\section{Ciekawostka}\label{ciekawostka-3}
...
\chapter{Bojowy Wóz Piechoty BMP-2}\label{bojowy-wuxf3z-piechoty-bmp-2}

\subsection{BMP-2 Infantry Fighting Vehicle \textbar{} БМП-2 (Боевая
машина
...
\section{Dane techniczne}\label{dane-techniczne-4}
...
\section{Ciekawostka}\label{ciekawostka-4}
...
\chapter{Bojowy Wóz Piechoty BMP-3}\label{bojowy-wuxf3z-piechoty-bmp-3}

\subsection{BMP-3 Infantry Fighting Vehicle \textbar{} БМП-3 (Боевая
машина
...
\section{Dane techniczne}\label{dane-techniczne-5}
...
\section{Ciekawostka}\label{ciekawostka-5}
...
\chapter{Transporter Opancerzony
BTR-80}\label{transporter-opancerzony-btr-80}

\subsection{BTR-80 Armoured Personnel Carrier \textbar{}
Бронетранспортёр
...
\section{Dane techniczne}\label{dane-techniczne-6}
...
\section{Ciekawostka}\label{ciekawostka-6}
...
\subsection{BTR-90 Armoured Personnel Carrier \textbar{}
Бронетранспортёр
...
\section{Dane techniczne}\label{dane-techniczne-7}
...
\section{Ciekawostka}\label{ciekawostka-7}
...
\chapter{Rosyjskie pojazdy MRAP / GAZ
Tigr}\label{rosyjskie-pojazdy-mrap-gaz-tigr}

\subsection{Russian MRAP / GAZ Tigr Light Multipurpose Vehicle
\textbar{} ГАЗ
...
\section{Dane techniczne}\label{dane-techniczne-8}
...
\section{Ciekawostka}\label{ciekawostka-8}
...
\chapter{Haubica samobieżna 2S1
Goździk}\label{haubica-samobieux17cna-2s1-goux17adzik}

\subsection{2S1 Gvozdika Self-Propelled Howitzer \textbar{} 2С1
...
\section{Dane techniczne}\label{dane-techniczne-9}
...
\section{Ciekawostka}\label{ciekawostka-9}
...
\chapter{Haubica samobieżna 2S3
Akacja}\label{haubica-samobieux17cna-2s3-akacja}

\subsection{2S3 Akatsiya Self-Propelled Howitzer \textbar{} 2С3
...
\section{Dane techniczne}\label{dane-techniczne-10}
...
\section{Ciekawostka}\label{ciekawostka-10}
...
\chapter{Armata samobieżna 2S5
Hiacynt-S}\label{armata-samobieux17cna-2s5-hiacynt-s}

\subsection{2S5 Giatsint-S Self-Propelled Gun \textbar{} 2С5
...
\section{Dane techniczne}\label{dane-techniczne-11}
...
\section{Ciekawostka}\label{ciekawostka-11}
...
\chapter{Moździerz samobieżny 2S9
Nona-S}\label{moux17adzierz-samobieux17cny-2s9-nona-s}

\subsection{2S9 Nona-S Self-Propelled Mortar \textbar{} 2С9
...
\section{Dane techniczne}\label{dane-techniczne-12}
...
\section{Ciekawostka}\label{ciekawostka-12}
...
\chapter{Moździerz samobieżny 2S23
Nona-SVK}\label{moux17adzierz-samobieux17cny-2s23-nona-svk}

\subsection{2S23 Nona-SVK Self-Propelled Mortar \textbar{} 2С23
...
\section{Dane techniczne}\label{dane-techniczne-13}
...
\section{Ciekawostka}\label{ciekawostka-13}
...
\chapter{Moździerz samobieżny 2S4
Tulipan}\label{moux17adzierz-samobieux17cny-2s4-tulipan}

\subsection{2S4 Tyulpan Self-Propelled Mortar \textbar{} 2С4
...
\section{Dane techniczne}\label{dane-techniczne-14}
...
\section{Ciekawostka}\label{ciekawostka-14}
...
\section{Dane techniczne}\label{dane-techniczne-15}
...
\section{Ciekawostka}\label{ciekawostka-15}
...
\chapter{Haubica holowana D-30 (2A18)}\label{haubica-holowana-d-30-2a18}

\subsection{D-30 122mm Towed Howitzer \textbar{} Д-30
...
\section{Dane techniczne}\label{dane-techniczne-16}
...
\section{Ciekawostka}\label{ciekawostka-16}
...
\chapter{Haubica polowa M-30}\label{haubica-polowa-m-30}

\subsection{M-30 Field Howitzer \textbar{} М-30 (122-мм гаубица обр.
1938
г.)}\label{m-30-field-howitzer-ux43c-30-122-ux43cux43c-ux433ux430ux443ux431ux438ux446ux430-ux43eux431ux440.-1938-ux433.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-17}
...
\section{Dane techniczne}\label{dane-techniczne-17}
...
\section{Ciekawostka}\label{ciekawostka-17}
...
\chapter{Armata polowa M-46}\label{armata-polowa-m-46}

\subsection{M-46 Field Gun \textbar{} М-46 (130-мм пушка обр. 1954
г.)}\label{m-46-field-gun-ux43c-46-130-ux43cux43c-ux43fux443ux448ux43aux430-ux43eux431ux440.-1954-ux433.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-18}
...
\section{Dane techniczne}\label{dane-techniczne-18}
...
\section{Ciekawostka}\label{ciekawostka-18}
...
\chapter{Haubica D-1}\label{haubica-d-1}

\subsection{D-1 Howitzer \textbar{} Д-1 (152-мм гаубица обр. 1943
г.)}\label{d-1-howitzer-ux434-1-152-ux43cux43c-ux433ux430ux443ux431ux438ux446ux430-ux43eux431ux440.-1943-ux433.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-19}
...
\section{Dane techniczne}\label{dane-techniczne-19}
...
\section{Ciekawostka}\label{ciekawostka-19}
...
\chapter{Haubica-armata D-20}\label{haubica-armata-d-20}

\subsection{D-20 Gun-Howitzer \textbar{} Д-20 (152-мм
...
\section{Dane techniczne}\label{dane-techniczne-20}
...
\section{Ciekawostka}\label{ciekawostka-20}
...
\chapter{Haubica 2A65 Msta-B}\label{haubica-2a65-msta-b}

\subsection{2A65 Msta-B Howitzer \textbar{} 2А65
«Мста-Б»}\label{a65-msta-b-howitzer-2ux43065-ux43cux441ux442ux430-ux431}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-21}
...
\section{Dane techniczne}\label{dane-techniczne-21}
...
\section{Ciekawostka}\label{ciekawostka-21}
...
\chapter{Armata 2A36 Giacynt-B}\label{armata-2a36-giacynt-b}

\subsection{2A36 Giatsint-B Field Gun \textbar{} 2А36
«Гиацинт-Б»}\label{a36-giatsint-b-field-gun-2ux43036-ux433ux438ux430ux446ux438ux43dux442-ux431}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-22}
...
\section{Dane techniczne}\label{dane-techniczne-22}
...
\section{Ciekawostka}\label{ciekawostka-22}
...
\chapter{Armata przeciwpancerna MT-12
Rapira}\label{armata-przeciwpancerna-mt-12-rapira}

\subsection{MT-12 Rapira 100mm Anti-Tank Gun \textbar{} МТ-12
...
\section{Dane techniczne}\label{dane-techniczne-23}
...
\section{Ciekawostka}\label{ciekawostka-23}
...
\section{Dane techniczne}\label{dane-techniczne-24}
...
\section{Ciekawostka}\label{ciekawostka-24}
...
\chapter{Moździerz 2B14 Podnos}\label{moux17adzierz-2b14-podnos}

\subsection{2B14 Podnos Mortar \textbar{} 2Б14
«Поднос»}\label{b14-podnos-mortar-2ux43114-ux43fux43eux434ux43dux43eux441}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-25}
...
\section{Dane techniczne}\label{dane-techniczne-25}
...
\section{Ciekawostka}\label{ciekawostka-25}
...
\section{Dane techniczne}\label{dane-techniczne-26}
...
\section{Ciekawostka}\label{ciekawostka-26}
...
\chapter{System rakietowy dalekiego zasięgu
S-300}\label{system-rakietowy-dalekiego-zasiux119gu-s-300}

\subsection{S-300 Long-Range Air Defence System \textbar{}
...
\section{Dane techniczne}\label{dane-techniczne-27}
...
\section{Ciekawostka}\label{ciekawostka-27}
...
\chapter{System rakietowy dalekiego zasięgu S-400
Triumf}\label{system-rakietowy-dalekiego-zasiux119gu-s-400-triumf}

\subsection{S-400 Triumf Air Defence System \textbar{} С-400
...
\section{Dane techniczne}\label{dane-techniczne-28}
...
\section{Ciekawostka}\label{ciekawostka-28}
...
\chapter{System rakietowy krótkiego zasięgu
Tor}\label{system-rakietowy-kruxf3tkiego-zasiux119gu-tor}

\subsection{Tor Air Defence System \textbar{} Тор
...
\section{Dane techniczne}\label{dane-techniczne-29}
...
\section{Ciekawostka}\label{ciekawostka-29}
...
\chapter{Artyleryjsko-rakietowy system p-lot
Pancerz-S1}\label{artyleryjsko-rakietowy-system-p-lot-pancerz-s1}

\subsection{Pantsir-S1 Air Defence System \textbar{}
...
\section{Dane techniczne}\label{dane-techniczne-30}
...
\section{Ciekawostka}\label{ciekawostka-30}
...
\section{Dane techniczne}\label{dane-techniczne-31}
...
\section{Ciekawostka}\label{ciekawostka-31}
...
\chapter{Przenośny system rakietowy 9K38 Igła
(MANPADS)}\label{przenoux15bny-system-rakietowy-9k38-igux142a-manpads}

\subsection{9K38 Igla Man-Portable Air Defence System \textbar{} 9К38
...
\section{Dane techniczne}\label{dane-techniczne-32}
...
\section{Ciekawostka}\label{ciekawostka-32}
...
\chapter{Przenośny system rakietowy 9K333 Wierba
(MANPADS)}\label{przenoux15bny-system-rakietowy-9k333-wierba-manpads}

\subsection{9K333 Verba Man-Portable Air Defence System \textbar{} 9К333
...
\section{Dane techniczne}\label{dane-techniczne-33}
...
\section{Ciekawostka}\label{ciekawostka-33}
...
\chapter{Przeciwpancerny pocisk kierowany 9K111
Fagot}\label{przeciwpancerny-pocisk-kierowany-9k111-fagot}

\subsection{9K111 Fagot Anti-Tank Guided Missile \textbar{} 9К111
...
\section{Dane techniczne}\label{dane-techniczne-34}
...
\section{Ciekawostka}\label{ciekawostka-34}
...
\section{Dane techniczne}\label{dane-techniczne-35}
...
\section{Ciekawostka}\label{ciekawostka-35}
...
\chapter{Lekki ppk 9K115 Metis}\label{lekki-ppk-9k115-metis}

\subsection{9K115 Metis Anti-Tank Guided Missile \textbar{} 9К115
«Метис»}\label{k115-metis-anti-tank-guided-missile-9ux43a115-ux43cux435ux442ux438ux441}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-36}
...
\section{Dane techniczne}\label{dane-techniczne-36}
...
\section{Ciekawostka}\label{ciekawostka-36}
...
\chapter{Lekki ppk 9K115-2 Metis-M}\label{lekki-ppk-9k115-2-metis-m}

\subsection{9K115-2 Metis-M Anti-Tank Guided Missile \textbar{} 9К115-2
«Метис-М»}\label{k115-2-metis-m-anti-tank-guided-missile-9ux43a115-2-ux43cux435ux442ux438ux441-ux43c}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-37}
...
\section{Dane techniczne}\label{dane-techniczne-37}
...
\section{Ciekawostka}\label{ciekawostka-37}
...
\section{Dane techniczne}\label{dane-techniczne-38}
...
\section{Ciekawostka}\label{ciekawostka-38}
...
\chapter{Mi-24 Hind}\label{mi-24-hind}

\subsection{Mil Mi-24 \textbar{} Миль
...
\section{Dane techniczne}\label{dane-techniczne-39}
...
\section{Ciekawostka}\label{ciekawostka-39}
...
\chapter{Mi-28 Havoc}\label{mi-28-havoc}

\subsection{Mil Mi-28N Night Hunter \textbar{} Миль Ми-28Н «Ночной
...
\section{Dane techniczne}\label{dane-techniczne-40}
...
\section{Ciekawostka}\label{ciekawostka-40}
...
\chapter{Ka-52 Aligator}\label{ka-52-aligator}

\subsection{Kamov Ka-52 Alligator \textbar{} Камов Ка-52
...
\section{Dane techniczne}\label{dane-techniczne-41}
...
\section{Ciekawostka}\label{ciekawostka-41}
...
\chapter{Su-25 Gracz}\label{su-25-gracz}

\subsection{Sukhoi Su-25 Frogfoot \textbar{} Сухой Су-25
...
\section{Dane techniczne}\label{dane-techniczne-42}
...
\section{Ciekawostka}\label{ciekawostka-42}
...
\chapter{Su-27 Flanker}\label{su-27-flanker}

\subsection{Sukhoi Su-27 Flanker \textbar{} Сухой
...
\section{Dane techniczne}\label{dane-techniczne-43}
...
\section{Ciekawostka}\label{ciekawostka-43}
...
\chapter{Karabin szturmowy AK-74}\label{karabin-szturmowy-ak-74}

\subsection{AK-74 Assault Rifle \textbar{}
...
\section{Dane techniczne}\label{dane-techniczne-44}
...
\section{Ciekawostka}\label{ciekawostka-44}
...
\section{Dane techniczne}\label{dane-techniczne-45}
...
\section{Ciekawostka}\label{ciekawostka-45}
...
\chapter{Karabin szturmowy AKM}\label{karabin-szturmowy-akm}

\subsection{AKM Assault Rifle \textbar{} АКМ (Автомат Калашникова
...
\section{Dane techniczne}\label{dane-techniczne-46}
...
\section{Ciekawostka}\label{ciekawostka-46}
...
\chapter{Karabin szturmowy AK-12}\label{karabin-szturmowy-ak-12}

\subsection{AK-12 Assault Rifle \textbar{}
...
\section{Dane techniczne}\label{dane-techniczne-47}
...
\section{Ciekawostka}\label{ciekawostka-47}
...
\chapter{Karabin szturmowy AK-103}\label{karabin-szturmowy-ak-103}

\subsection{AK-103 Assault Rifle \textbar{}
АК-103}\label{ak-103-assault-rifle-ux430ux43a-103}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-48}
...
\section{Dane techniczne}\label{dane-techniczne-48}
...
\section{Ciekawostka}\label{ciekawostka-48}
...
\chapter{Karabin szturmowy AK-15}\label{karabin-szturmowy-ak-15}

\subsection{AK-15 Assault Rifle \textbar{}
АК-15}\label{ak-15-assault-rifle-ux430ux43a-15}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-49}
...
\section{Dane techniczne}\label{dane-techniczne-49}
...
\section{Ciekawostka}\label{ciekawostka-49}
...
\section{Dane techniczne}\label{dane-techniczne-50}
...
\section{Ciekawostka}\label{ciekawostka-50}
...
\chapter{Karabin szturmowy AEK-971}\label{karabin-szturmowy-aek-971}

\subsection{AEK-971 Assault Rifle \textbar{}
АЕК-971}\label{aek-971-assault-rifle-ux430ux435ux43a-971}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-51}
...
\section{Dane techniczne}\label{dane-techniczne-51}
...
\section{Ciekawostka}\label{ciekawostka-51}
...
\chapter{Karabin szturmowy SR-3 Wihr}\label{karabin-szturmowy-sr-3-wihr}

\subsection{SR-3 Vikhr Assault Rifle \textbar{} СР-3
«Вихрь»}\label{sr-3-vikhr-assault-rifle-ux441ux440-3-ux432ux438ux445ux440ux44c}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-52}
...
\section{Dane techniczne}\label{dane-techniczne-52}
...
\section{Ciekawostka}\label{ciekawostka-52}
...
\chapter{Karabin szturmowy AS Val}\label{karabin-szturmowy-as-val}

\subsection{AS Val Assault Rifle \textbar{} АС
«Вал»}\label{as-val-assault-rifle-ux430ux441-ux432ux430ux43b}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-53}
...
\section{Dane techniczne}\label{dane-techniczne-53}
...
\section{Ciekawostka}\label{ciekawostka-53}
...
\chapter{Ręczny karabin maszynowy
RPK}\label{rux119czny-karabin-maszynowy-rpk}

\subsection{RPK Light Machine Gun \textbar{} РПК (Ручной пулемёт
...
\section{Dane techniczne}\label{dane-techniczne-54}
...
\section{Ciekawostka}\label{ciekawostka-54}
...
\subsection{RPL-20 Light Machine Gun \textbar{}
РПЛ-20}\label{rpl-20-light-machine-gun-ux440ux43fux43b-20}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-55}
...
\section{Dane techniczne}\label{dane-techniczne-55}
...
\section{Ciekawostka}\label{ciekawostka-55}
...
\chapter{Karabin maszynowy PK / PKM}\label{karabin-maszynowy-pk-pkm}

\subsection{PK/PKM General-Purpose Machine Gun \textbar{} ПК / ПКМ
(Пулемёт
...
\section{Dane techniczne}\label{dane-techniczne-56}
...
\section{Ciekawostka}\label{ciekawostka-56}
...
\section{Dane techniczne}\label{dane-techniczne-57}
...
\section{Ciekawostka}\label{ciekawostka-57}
...
\chapter{Ciężki karabin maszynowy
DszkK}\label{ciux119ux17cki-karabin-maszynowy-dszkk}

\subsection{DShK Heavy Machine Gun \textbar{} ДШК (Дегтярёв-Шпагин
...
\section{Dane techniczne}\label{dane-techniczne-58}
...
\section{Ciekawostka}\label{ciekawostka-58}
...
\subsection{NSV Heavy Machine Gun \textbar{} НСВ «Утёс»
(Utes)}\label{nsv-heavy-machine-gun-ux43dux441ux432-ux443ux442ux451ux441-utes}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-59}
...
\section{Dane techniczne}\label{dane-techniczne-59}
...
\section{Ciekawostka}\label{ciekawostka-59}
...
\subsection{Kord Heavy Machine Gun \textbar{} Корд
(6П50)}\label{kord-heavy-machine-gun-ux43aux43eux440ux434-6ux43f50}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-60}
...
\section{Dane techniczne}\label{dane-techniczne-60}
...
\section{Ciekawostka}\label{ciekawostka-60}
...
\section{Dane techniczne}\label{dane-techniczne-61}
...
\section{Ciekawostka}\label{ciekawostka-61}
...
\chapter{Karabin snajperski SVD
Dragunow}\label{karabin-snajperski-svd-dragunow}

\subsection{SVD Dragunov Sniper Rifle \textbar{} СВД (Снайперская
винтовка
...
\section{Dane techniczne}\label{dane-techniczne-62}
...
\section{Ciekawostka}\label{ciekawostka-62}
...
\chapter{Karabin snajperski SV-98}\label{karabin-snajperski-sv-98}

\subsection{SV-98 Sniper Rifle \textbar{}
СВ-98}\label{sv-98-sniper-rifle-ux441ux432-98}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-63}
...
\section{Dane techniczne}\label{dane-techniczne-63}
...
\section{Ciekawostka}\label{ciekawostka-63}
...
\section{Dane techniczne}\label{dane-techniczne-64}
...
\section{Ciekawostka}\label{ciekawostka-64}
...
\chapter{Karabin snajperski KSVK
12,7}\label{karabin-snajperski-ksvk-127}

\subsection{KSVK 12.7 Anti-Materiel Rifle \textbar{} КСВК
12,7}\label{ksvk-12.7-anti-materiel-rifle-ux43aux441ux432ux43a-127}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-65}
...
\section{Dane techniczne}\label{dane-techniczne-65}
...
\section{Ciekawostka}\label{ciekawostka-65}
...
\chapter{Karabin snajperski OSV-96}\label{karabin-snajperski-osv-96}

\subsection{OSV-96 Anti-Materiel Rifle \textbar{}
ОСВ-96}\label{osv-96-anti-materiel-rifle-ux43eux441ux432-96}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-66}
...
\section{Dane techniczne}\label{dane-techniczne-66}
...
\section{Ciekawostka}\label{ciekawostka-66}
...
\chapter{Karabin snajperski Lobaev SVLK-14S
Sumrak}\label{karabin-snajperski-lobaev-svlk-14s-sumrak}

\subsection{Lobaev SVLK-14S Sumrak Extreme Long Range Rifle \textbar{}
Лобаев СВЛК-14С
...
\section{Dane techniczne}\label{dane-techniczne-67}
...
\section{Ciekawostka}\label{ciekawostka-67}
...
\chapter{Granatnik przeciwpancerny
RPG-7}\label{granatnik-przeciwpancerny-rpg-7}

\subsection{RPG-7 Anti-Tank Grenade Launcher \textbar{}
РПГ-7}\label{rpg-7-anti-tank-grenade-launcher-ux440ux43fux433-7}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-68}
...
\section{Dane techniczne}\label{dane-techniczne-68}
...
\section{Ciekawostka}\label{ciekawostka-68}
...
\section{Dane techniczne}\label{dane-techniczne-69}
...
\section{Ciekawostka}\label{ciekawostka-69}
...
\section{Dane techniczne}\label{dane-techniczne-70}
...
\section{Ciekawostka}\label{ciekawostka-70}
...
\section{Dane techniczne}\label{dane-techniczne-71}
...
\section{Ciekawostka}\label{ciekawostka-71}
...
\section{Dane techniczne}\label{dane-techniczne-72}
...
\section{Ciekawostka}\label{ciekawostka-72}
...
\section{Dane techniczne}\label{dane-techniczne-73}
...
\section{Ciekawostka}\label{ciekawostka-73}
...
\section{Dane techniczne}\label{dane-techniczne-74}
...
\section{Ciekawostka}\label{ciekawostka-74}
...
\section{Dane techniczne}\label{dane-techniczne-75}
...
\section{Ciekawostka}\label{ciekawostka-75}
...
\chapter{Jednorazowy granatnik termobaryczny
RShG-1}\label{jednorazowy-granatnik-termobaryczny-rshg-1}

\subsection{RShG-1 Thermobaric Rocket Launcher \textbar{}
РШГ-1}\label{rshg-1-thermobaric-rocket-launcher-ux440ux448ux433-1}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-76}
...
\section{Dane techniczne}\label{dane-techniczne-76}
...
\section{Ciekawostka}\label{ciekawostka-76}
...
\section{Dane techniczne}\label{dane-techniczne-77}
...
\section{Ciekawostka}\label{ciekawostka-77}
...
\section{Dane techniczne}\label{dane-techniczne-78}
...
\section{Ciekawostka}\label{ciekawostka-78}
...
\section{Dane techniczne}\label{dane-techniczne-79}
...
\section{Ciekawostka}\label{ciekawostka-79}
...
\section{Dane techniczne}\label{dane-techniczne-80}
...
\section{Ciekawostka}\label{ciekawostka-80}
...
\chapter{Nasadkowy granatnik GP-34}\label{nasadkowy-granatnik-gp-34}

\subsection{GP-34 Underbarrel Grenade Launcher \textbar{}
ГП-34}\label{gp-34-underbarrel-grenade-launcher-ux433ux43f-34}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-81}
...
\section{Dane techniczne}\label{dane-techniczne-81}
...
\section{Ciekawostka}\label{ciekawostka-81}
...
\section{Dane techniczne}\label{dane-techniczne-82}
...
\section{Ciekawostka}\label{ciekawostka-82}
...
\chapter{Automatyczny granatnik
AGS-30}\label{automatyczny-granatnik-ags-30}

\subsection{AGS-30 Automatic Grenade Launcher \textbar{}
АГС-30}\label{ags-30-automatic-grenade-launcher-ux430ux433ux441-30}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-83}
...
\section{Dane techniczne}\label{dane-techniczne-83}
...
\section{Ciekawostka}\label{ciekawostka-83}
...
\section{Dane techniczne}\label{dane-techniczne-84}
...
\section{Ciekawostka}\label{ciekawostka-84}
...
\chapter{Rewolwerowy granatnik GM-94}\label{rewolwerowy-granatnik-gm-94}

\subsection{GM-94 Pump-Action Grenade Launcher \textbar{}
ГМ-94}\label{gm-94-pump-action-grenade-launcher-ux433ux43c-94}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-85}
...
\section{Dane techniczne}\label{dane-techniczne-85}
...
\section{Ciekawostka}\label{ciekawostka-85}
...
\chapter{Pistolet Makarowa PM}\label{pistolet-makarowa-pm}

\subsection{Makarov PM Pistol \textbar{} ПМ (Пистолет
...
\section{Dane techniczne}\label{dane-techniczne-86}
...
\section{Ciekawostka}\label{ciekawostka-86}
...
\section{Dane techniczne}\label{dane-techniczne-87}
...
\section{Ciekawostka}\label{ciekawostka-87}
...
\chapter{Pistolet maszynowy APS
(Steczkin)}\label{pistolet-maszynowy-aps-steczkin}

\subsection{APS Stechkin Machine Pistol \textbar{} АПС (Автоматический
Пистолет
...
\section{Dane techniczne}\label{dane-techniczne-88}
...
\section{Ciekawostka}\label{ciekawostka-88}
...
\chapter{Pistolet tłumiony PB (6P9)}\label{pistolet-tux142umiony-pb-6p9}

\subsection{PB Silent Pistol \textbar{} ПБ (Пистолет
...
\section{Dane techniczne}\label{dane-techniczne-89}
...
\section{Ciekawostka}\label{ciekawostka-89}
...
\chapter{Pistolet PSM}\label{pistolet-psm}

\subsection{PSM Pistol \textbar{} ПСМ (Пистолет Самозарядный
...
\section{Dane techniczne}\label{dane-techniczne-90}
...
\section{Ciekawostka}\label{ciekawostka-90}
...
\chapter{Pistolet MP-443 Grach}\label{pistolet-mp-443-grach}

\subsection{MP-443 Grach (PYa) Pistol \textbar{} МП-443 «Грач»
(ПЯ)}\label{mp-443-grach-pya-pistol-ux43cux43f-443-ux433ux440ux430ux447-ux43fux44f}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-91}
...
\section{Dane techniczne}\label{dane-techniczne-91}
...
\section{Ciekawostka}\label{ciekawostka-91}
...
\chapter{Pistolet GSz-18}\label{pistolet-gsz-18}

\subsection{GSh-18 Pistol \textbar{}
ГШ-18}\label{gsh-18-pistol-ux433ux448-18}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-92}
...
\section{Dane techniczne}\label{dane-techniczne-92}
...
\section{Ciekawostka}\label{ciekawostka-92}
...
\chapter{Pistolet SR-1 Wektor (SPS)}\label{pistolet-sr-1-wektor-sps}

\subsection{SR-1 Vektor (SPS) Pistol \textbar{} СР-1 «Вектор»
(СПС)}\label{sr-1-vektor-sps-pistol-ux441ux440-1-ux432ux435ux43aux442ux43eux440-ux441ux43fux441}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-93}
...
\section{Dane techniczne}\label{dane-techniczne-93}
...
\section{Ciekawostka}\label{ciekawostka-93}
...
\section{Dane techniczne}\label{dane-techniczne-94}
...
\section{Ciekawostka}\label{ciekawostka-94}
...
\section{Dane techniczne}\label{dane-techniczne-95}
...
\section{Ciekawostka}\label{ciekawostka-95}
...
\section{Dane techniczne}\label{dane-techniczne-96}
...
\section{Ciekawostka}\label{ciekawostka-96}
...
\chapter{Pistolet maszynowy PP-2000}\label{pistolet-maszynowy-pp-2000}

\subsection{PP-2000 Submachine Gun \textbar{}
ПП-2000}\label{pp-2000-submachine-gun-ux43fux43f-2000}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-97}
...
\section{Dane techniczne}\label{dane-techniczne-97}
...
\section{Ciekawostka}\label{ciekawostka-97}
...
\section{Dane techniczne}\label{dane-techniczne-98}
...
\section{Ciekawostka}\label{ciekawostka-98}
...
\chapter{Pistolet podwodny SPP-1M}\label{pistolet-podwodny-spp-1m}

\subsection{SPP-1M Underwater Pistol \textbar{}
СПП-1М}\label{spp-1m-underwater-pistol-ux441ux43fux43f-1ux43c}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-99}
...
\section{Dane techniczne}\label{dane-techniczne-99}
...
\section{Ciekawostka}\label{ciekawostka-99}
...
\chapter{Podwodny karabinek APS}\label{podwodny-karabinek-aps}

\subsection{APS Underwater Assault Rifle \textbar{} АПС (Автомат
Подводный
...
\section{Dane techniczne}\label{dane-techniczne-100}
...
\section{Ciekawostka}\label{ciekawostka-100}
...
\chapter{Granat ręczny F-1}\label{granat-rux119czny-f-1}

\subsection{F-1 Hand Grenade \textbar{} Ф-1
(«Лимонка»)}\label{f-1-hand-grenade-ux444-1-ux43bux438ux43cux43eux43dux43aux430}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-101}
...
\section{Dane techniczne}\label{dane-techniczne-101}
...
\section{Ciekawostka}\label{ciekawostka-101}
...
\chapter{Granat ręczny RGD-5}\label{granat-rux119czny-rgd-5}

\subsection{RGD-5 Hand Grenade \textbar{}
РГД-5}\label{rgd-5-hand-grenade-ux440ux433ux434-5}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-102}
...
\section{Dane techniczne}\label{dane-techniczne-102}
...
\section{Ciekawostka}\label{ciekawostka-102}
...
\chapter{Granat ręczny RGN}\label{granat-rux119czny-rgn}

\subsection{RGN Hand Grenade \textbar{} РГН (Ручная Граната
...
\section{Dane techniczne}\label{dane-techniczne-103}
...
\section{Ciekawostka}\label{ciekawostka-103}
...
\chapter{Granat ręczny RGO}\label{granat-rux119czny-rgo}

\subsection{RGO Hand Grenade \textbar{} РГО (Ручная Граната
...
\section{Dane techniczne}\label{dane-techniczne-104}
...
\section{Ciekawostka}\label{ciekawostka-104}
...
\chapter{Granat przeciwpancerny
RKG-3}\label{granat-przeciwpancerny-rkg-3}

\subsection{RKG-3 Anti-Tank Hand Grenade \textbar{}
РКГ-3}\label{rkg-3-anti-tank-hand-grenade-ux440ux43aux433-3}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-105}
...
\section{Dane techniczne}\label{dane-techniczne-105}
...
\section{Ciekawostka}\label{ciekawostka-105}
...
\chapter{Granat do granatnika VOG-25}\label{granat-do-granatnika-vog-25}

\subsection{VOG-25 Grenade Round \textbar{}
ВОГ-25}\label{vog-25-grenade-round-ux432ux43eux433-25}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-106}
...
\section{Dane techniczne}\label{dane-techniczne-106}
...
\section{Ciekawostka}\label{ciekawostka-106}
...
\chapter{Mina przeciwpiechotna PMN}\label{mina-przeciwpiechotna-pmn}

\subsection{PMN Anti-Personnel Mine \textbar{}
ПМН}\label{pmn-anti-personnel-mine-ux43fux43cux43d}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-107}
...
\section{Dane techniczne}\label{dane-techniczne-107}
...
\section{Ciekawostka}\label{ciekawostka-107}
...
\chapter{Mina przeciwpiechotna PMN-2}\label{mina-przeciwpiechotna-pmn-2}

\subsection{PMN-2 Anti-Personnel Mine \textbar{}
ПМН-2}\label{pmn-2-anti-personnel-mine-ux43fux43cux43d-2}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-108}
...
\section{Dane techniczne}\label{dane-techniczne-108}
...
\section{Ciekawostka}\label{ciekawostka-108}
...
\chapter{Mina przeciwpiechotna
OZM-72}\label{mina-przeciwpiechotna-ozm-72}

\subsection{OZM-72 Bounding Mine \textbar{}
ОЗМ-72}\label{ozm-72-bounding-mine-ux43eux437ux43c-72}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-109}
...
\section{Dane techniczne}\label{dane-techniczne-109}
...
\section{Ciekawostka}\label{ciekawostka-109}
...
\chapter{Mina przeciwpiechotna POM-2}\label{mina-przeciwpiechotna-pom-2}

\subsection{POM-2 Anti-Personnel Mine \textbar{}
ПОМ-2}\label{pom-2-anti-personnel-mine-ux43fux43eux43c-2}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-110}
...
\section{Dane techniczne}\label{dane-techniczne-110}
...
\section{Ciekawostka}\label{ciekawostka-110}
...
\chapter{Mina-motyl PFM-1}\label{mina-motyl-pfm-1}

\subsection{PFM-1 Butterfly Mine \textbar{} ПФМ-1 («Попугай»,
...
\section{Dane techniczne}\label{dane-techniczne-111}
...
\section{Ciekawostka}\label{ciekawostka-111}
...
\chapter{Mina kierunkowa MON-50}\label{mina-kierunkowa-mon-50}

\subsection{MON-50 Directional Mine \textbar{}
МОН-50}\label{mon-50-directional-mine-ux43cux43eux43d-50}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-112}
...
\section{Dane techniczne}\label{dane-techniczne-112}
...
\section{Ciekawostka}\label{ciekawostka-112}
...
\chapter{Mina kierunkowa MON-100}\label{mina-kierunkowa-mon-100}

\subsection{MON-100 Directional Mine \textbar{}
МОН-100}\label{mon-100-directional-mine-ux43cux43eux43d-100}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-113}
...
\section{Dane techniczne}\label{dane-techniczne-113}
...
\section{Ciekawostka}\label{ciekawostka-113}
...
\chapter{Mina przeciwpancerna TM-57}\label{mina-przeciwpancerna-tm-57}

\subsection{TM-57 Anti-Tank Mine \textbar{}
ТМ-57}\label{tm-57-anti-tank-mine-ux442ux43c-57}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-114}
...
\section{Dane techniczne}\label{dane-techniczne-114}
...
\section{Ciekawostka}\label{ciekawostka-114}
...
\chapter{Mina przeciwpancerna TM-62M}\label{mina-przeciwpancerna-tm-62m}

\subsection{TM-62M Anti-Tank Mine \textbar{}
ТМ-62М}\label{tm-62m-anti-tank-mine-ux442ux43c-62ux43c}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-115}
...
\section{Dane techniczne}\label{dane-techniczne-115}
...
\section{Ciekawostka}\label{ciekawostka-115}
...
\chapter{Mina przeciwpancerna PTM-3}\label{mina-przeciwpancerna-ptm-3}

\subsection{PTM-3 Anti-Tank Mine \textbar{}
ПТМ-3}\label{ptm-3-anti-tank-mine-ux43fux442ux43c-3}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-116}
...
\section{Dane techniczne}\label{dane-techniczne-116}
...
\section{Ciekawostka}\label{ciekawostka-116}
...
\chapter{Mina kasetowa KPOM-2}\label{mina-kasetowa-kpom-2}

\subsection{KPOM-2 Cluster Submunition \textbar{}
КПОМ-2}\label{kpom-2-cluster-submunition-ux43aux43fux43eux43c-2}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-117}
...
\section{Dane techniczne}\label{dane-techniczne-117}
...
\section{Ciekawostka}\label{ciekawostka-117}
...
\chapter{System minowania UMZ}\label{system-minowania-umz}

\subsection{UMZ Scatterable Mine System \textbar{} УМЗ (Универсальный
Минный
...
\section{Dane techniczne}\label{dane-techniczne-118}
...
\section{Ciekawostka}\label{ciekawostka-118}
...
\chapter{Mina przeciwpancerna VS-50}\label{mina-przeciwpancerna-vs-50}

\subsection{VS-50 Anti-Personnel Mine \textbar{}
ВС-50}\label{vs-50-anti-personnel-mine-ux432ux441-50}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Opis}\label{opis-119}
...
\section{Dane techniczne}\label{dane-techniczne-119}
...
\section{Ciekawostka}\label{ciekawostka-119}
